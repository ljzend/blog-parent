...
public class CodeGenerator {
     ...
     * The Mysql url.
     */
    private static final String MYSQL_URL = "jdbc:mysql://127.0.0.1:3307/my-blog?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai";
    /**
     * The Mysql username.
     */
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(MYSQL_URL, MYSQL_USERNAME, MYSQL_PASSWORD)
                ...
                .packageConfig(builder -> {
                    builder.parent("com.ljz.back") // 父包名
